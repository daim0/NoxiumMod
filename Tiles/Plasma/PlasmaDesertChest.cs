...
{
    class PlasmaDesertChest : ModTile
    {
        public override void SetDefaults()
        {
            ...
            chest = "Example Chest";
            chestDrop = ItemType<Items.Placeable.Plasma.PlasmaDesertChestItem>();
        }
        ...
        public override bool NewRightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    int key = ItemType<Items.Consumable.PlasmaDesertKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.showItemIcon2 = ItemType<Items.Placeable.Plasma.PlasmaDesertChestItem>();
                    if (Main.tile[left, top].frameX / 36 == 1)
                        player.showItemIcon2 = ItemType<Items.Consumable.PlasmaDesertKey>();
