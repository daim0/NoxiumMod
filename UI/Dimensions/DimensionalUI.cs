...
{
    public class DimensionalUI : UIState 
    {
        ...
        private UserInterface Interface => NoxiumMod.noxiumInstance.dimensionalInterface;
        ...
        public void LoadUI()
        {
            ...
            mainPanelTexture = GetTexture("NoxiumMod/UI/Dimensions/MainPanel");
            defaultDimensionTexture = GetTexture("NoxiumMod/UI/Dimensions/DefaultDimensionImage"); // This is the one that shows up when no dimensions have been detected (all the conditions for the other dimensions have failed).
            dimensionImageFrame = GetTexture("NoxiumMod/UI/Dimensions/DimensionImageFrame");
            leftArrowTex = GetTexture("NoxiumMod/UI/Dimensions/LeftArrow");
            leftArrowTexHover = GetTexture("NoxiumMod/UI/Dimensions/LeftArrowHover");
            rightArrowTex = GetTexture("NoxiumMod/UI/Dimensions/RightArrow");
            rightArrowTexHover = GetTexture("NoxiumMod/UI/Dimensions/RightArrowHover");
            exitButtonTexture = GetTexture("NoxiumMod/UI/Dimensions/ExitButton");
