    ...
    class LightningBolt : ILightning
    {
        ...
        public class Line
        {
            ...
            public void Draw(SpriteBatch spriteBatch, Color tint)
            {
                ...
                Texture2D HalfCircle = ModContent.GetTexture("NoxiumMod/Utilities/HalfCircle");
                Texture2D LightningSegment = ModContent.GetTexture("NoxiumMod/Utilities/LightningSegment");
                ...
                spriteBatch.Draw(LightningSegment, A, null, tint, theta, middleOrigin, middleScale, SpriteEffects.None, 0f);
                spriteBatch.Draw(HalfCircle, A, null, tint, theta, capOrigin, thicknessScale, SpriteEffects.None, 0f);
                spriteBatch.Draw(HalfCircle, B, null, tint, theta + MathHelper.Pi, capOrigin, thicknessScale, SpriteEffects.None, 0f);
            }
        }
    }
}
