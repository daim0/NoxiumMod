...
namespace NoxiumMod.Projectiles.Pets
{
    class PotionHead : ModProjectile
    {
        //All code here is pretty much elements awoken
        //Credit goes to them
        ...
        public override void AI()
        {
            ...
            if (player.dead)
            {
                modPlayer.PotionPet = false;
            }
            if (modPlayer.PotionPet)
            {
